...
CONFIG_KONA_ATAG_DT_DTS_FILE="Rhea_SS_Corsica"
...
# CONFIG_MACH_RHEA_SS_ZANIN is not set
...
# CONFIG_BCM_KNLLOG_SUPPORT is not set
...
CONFIG_ANDROID_PMEM_LOW_MEMORY_KILLER=y
# CONFIG_INTEL_MID_PTI is not set
# CONFIG_ICS932S401 is not set
# CONFIG_ENCLOSURE_SERVICES is not set
# CONFIG_APDS9802ALS is not set
# CONFIG_BRCM_VIRTUAL_SENSOR is not set
...
# CONFIG_AL3006 is not set
# CONFIG_BMP18X is not set
# CONFIG_SENSORS_AK8975 is not set
# CONFIG_SENSORS_BMA222 is not set
CONFIG_SENSORS_K3DH=y
CONFIG_SENSORS_ACC_12BIT=y
# CONFIG_SENSORS_ACC_FILTER is not set
# CONFIG_SENSORS_GP2AP002 is not set
# CONFIG_SENSORS_TAOS is not set
# CONFIG_SENSORS_PX3215 is not set
# CONFIG_SENSORS_MMC328X is not set
# CONFIG_SENSORS_HSCD is not set
# CONFIG_SENSORS_HSCDTD006A is not set
CONFIG_SENSORS_HSCDTD008A=y
CONFIG_SENSORS_MAG_15BIT=y
# CONFIG_SENSORS_BMC150 is not set
# CONFIG_DS1682 is not set
# CONFIG_TI_DAC7512 is not set
CONFIG_UID_STAT=y
# CONFIG_BMP085 is not set
# CONFIG_WL127X_RFKILL is not set
# CONFIG_BTHID is not set
# CONFIG_APANIC is not set
# CONFIG_APANIC_ON_MMC is not set
# CONFIG_INTER_PROCESSOR_COMM is not set
# CONFIG_BCMPMU_CSAPI_ADC is not set
CONFIG_BCMPMU_AUDIO=y
# CONFIG_BCMPMU_SELFTEST is not set
# CONFIG_MONITOR_ADC121C021_I2C is not set
# CONFIG_MONITOR_BQ27541_I2C is not set
# CONFIG_BRALLOC_MEM is not set
CONFIG_RECOVERY=y
CONFIG_BCM_RFKILL=y
CONFIG_BCM_BT_LPM=y
# CONFIG_BCM_USERFAULT_HANDLER is not set
# CONFIG_AMI306 is not set
CONFIG_STM_TRACE=y
CONFIG_STM_NUMBER_OF_CHANNEL=256
# CONFIG_STM_PRINTK is not set
# CONFIG_STM_FTRACE is not set
# CONFIG_STM_CTX_SWITCH is not set
# CONFIG_STM_WAKEUP is not set
# CONFIG_STM_STACK_TRACE is not set
# CONFIG_STM_TRACE_PRINTK is not set
...
# CONFIG_BRCM_EMMC_RPMB is not set
...
# CONFIG_CONFIG_DHD_USE_STATIC_BUF is not set
...
# CONFIG_KEYBOARD_KONA is not set
# CONFIG_KEYBOARD_LM8325 is not set
...
# CONFIG_KEYBOARD_EXPANDER is not set
...
# CONFIG_TOUCHSCREEN_BCM915500 is not set
...
# CONFIG_TOUCHSCREEN_MMS128_COOPERVE is not set
# CONFIG_TOUCHSCREEN_TMA140_LUCAS is not set
# CONFIG_TOUCHSCREEN_TMA140_CORIPLUS is not set
# CONFIG_TOUCHSCREEN_MMS128_TASSCOOPER is not set
# CONFIG_TOUCHSCREEN_TMA340_COOPERVE is not set
# CONFIG_TOUCHSCREEN_TMA340_LUCAS is not set
# CONFIG_TOUCHSCREEN_BT403_AMAZING is not set
# CONFIG_TOUCHSCREEN_S2200 is not set
# CONFIG_TOUCHSCREEN_BT403_ZANIN is not set
# CONFIG_TOUCHSCREEN_SYNAPTICS_I2C_RMI is not set
CONFIG_RMI4_FW_CORSICA=y
# CONFIG_RMI4_FW_CORSICASS is not set
...
# CONFIG_TOUCHSCREEN_TANGO is not set
# CONFIG_TOUCHSCREEN_W90X900 is not set
# CONFIG_TOUCHSCREEN_ST1232 is not set
# CONFIG_TOUCHSCREEN_TPS6507X is not set
# CONFIG_TOUCHSCREEN_EGALAX_I2C is not set
# CONFIG_TOUCHSCREEN_MMS134S is not set
CONFIG_TOUCHSCREEN_IST30XX=y
CONFIG_INPUT_MISC=y
...
# CONFIG_INPUT_SMB380 is not set
CONFIG_INPUT_PONKEY_BCMPMU=y
# CONFIG_INPUT_BCM2850_MIC_DETECT is not set
# CONFIG_KONA_HEADSET is not set
CONFIG_KONA_HEADSET_MULTI_BUTTON=y
# CONFIG_FIVE_PIN_EARJACK_SUPPORT is not set
CONFIG_RMI4_BUS=y
CONFIG_RMI4_DEBUG=y
CONFIG_RMI4_SPECIAL_EARLYSUSPEND=y
CONFIG_RMI4_I2C=y
...
CONFIG_VCE=y
CONFIG_BCM_MMUTIL=y
CONFIG_BRCM_FUSE_LOG=y
# CONFIG_STM_DEFAULT is not set
CONFIG_BCM_CPDUMP_INIRQ=y
CONFIG_ISP=y
CONFIG_UNICAM=y
CONFIG_BCMPMU_RPC=y
CONFIG_BCM_AP_PANIC_ON_CPCRASH=y
# CONFIG_BCM_MDMGPIO is not set
# CONFIG_BCM_AAA is not set
CONFIG_BCM_BSC=y
CONFIG_BCM_MODEM=y
# CONFIG_BCM_MODEM_DEFER_CP_START is not set
CONFIG_BCM_MODEM_EARLY_START=y
CONFIG_BRCM_FUSE_VSP=y
CONFIG_BCM_SIMLOCK=y
# CONFIG_BCM_IDLE_PROFILER is not set
# CONFIG_GPIO_USER_MODE_SUPPORT is not set
CONFIG_BCM_HEADSET_SW=y
# CONFIG_BCM_AMXR is not set
# CONFIG_BCM_HALAUDIO is not set
# CONFIG_BCM_VCP is not set
# CONFIG_BCM_GIST is not set
# CONFIG_BCM_SIGMORPH is not set
# CONFIG_BCM_HDMI_DET is not set
# CONFIG_BCM_WIFI_HDMI is not set
# CONFIG_VC_TEST_WIFI_HDMI is not set
CONFIG_GPS_IRQ=y
# CONFIG_BCM_RTC_CAL is not set
# CONFIG_BRCM_SIM_SECURE_ENABLE is not set
CONFIG_BCM_LOGRAM_HELPER=y
CONFIG_NEW_GPSCHIP_I2C=y
# CONFIG_RAMOOPS is not set
# CONFIG_BCM_GPS is not set
CONFIG_I2C=y
...
CONFIG_I2C_BSC=y
CONFIG_KONA_PMU_BSC_HS_MODE=y
# CONFIG_KONA_PMU_BSC_HS_1MHZ is not set
# CONFIG_KONA_PMU_BSC_HS_1625KHZ is not set
# CONFIG_I2C_BRCM_SSPI is not set
# CONFIG_I2C_DAC6571 is not set
...
# CONFIG_BATTERY_D2083 is not set
...
# CONFIG_POWER_BCMPMU is not set
CONFIG_BCMPMU_EM=y
CONFIG_CHARGER_BCMPMU_SPA=y
CONFIG_SEC_CHARGING_FEATURE=y
CONFIG_SPA_SUPPLEMENTARY_CHARGING=y
CONFIG_HWMON=y
...
# CONFIG_SENSORS_KONA is not set
...
# CONFIG_BCM_HAPTICS is not set
CONFIG_BCM_SS_VIBRA=y
...
# CONFIG_KONA_WATCHDOG is not set
# CONFIG_BCMPMU_WATCHDOG is not set
CONFIG_WD_TAPPER=y
...
CONFIG_MFD_CORE=y
CONFIG_MFD_BCMPMU=y
# CONFIG_MFD_BCM_PMU590XX is not set
CONFIG_MFD_BCMPMU_DBG=y
# CONFIG_TSP_SETTING_FOR_TA_USB_IN is not set
# CONFIG_MFD_BCM59055 is not set
CONFIG_MFD_BCM59039=y
# CONFIG_MFD_BCM59042 is not set
CONFIG_MFD_BCM_PWRMGR_SW_SEQUENCER=y
...
CONFIG_REGULATOR_BCMPMU=y
# CONFIG_REGULATOR_BCM59055 is not set
CONFIG_REGULATOR_BCM59039=y
# CONFIG_REGULATOR_BCM59042 is not set
# CONFIG_REGULATOR_TPS728XX is not set
...
# CONFIG_VIDEO_OV5640_MC is not set
...
# CONFIG_VIDEO_KONA is not set
CONFIG_SOC_CAMERA=y
# CONFIG_SOC_CAMERA_IMX074 is not set
# CONFIG_SOC_CAMERA_MT9M001 is not set
# CONFIG_SOC_CAMERA_MT9M111 is not set
# CONFIG_SOC_SUB_CAMERA is not set
...
# CONFIG_SOC_CAMERA_SR300PC20 is not set
# CONFIG_SOC_CAMERA_SR030PC50 is not set
CONFIG_SOC_CAMERA_SR200PC20M=y
# CONFIG_SOC_CAMERA_S5K5CCGX is not set
# CONFIG_SOC_CAMERA_TCM9001 is not set
# CONFIG_SOC_CAMERA_OV5640 is not set
# CONFIG_SOC_CAMERA_OV7692 is not set
# CONFIG_SOC_CAMERA_OV5640_GZ is not set
# CONFIG_SOC_CAMERA_OV7692_GZ is not set
...
CONFIG_FB=y
# CONFIG_FRAMEBUFFER_FPS is not set
...
CONFIG_BACKLIGHT_KTD259B=y
CONFIG_BACKLIGHT_KTD_CORSICA=y
# CONFIG_BACKLIGHT_KTD_CORSICASS is not set
# CONFIG_BACKLIGHT_NEVIS is not set
# CONFIG_KEYPAD_BACKLIGHT is not set
# CONFIG_TOUCHKEY_BACKLIGHT is not set
# CONFIG_GPIO_TOUCHKEY_BACKLIGHT is not set
...
# CONFIG_TFT_PANEL is not set
# CONFIG_LOGO is not set
CONFIG_FB_BRCM_RHEA=y
# CONFIG_CPU_AT_TURBO_WHILE_LCD_ON is not set
# CONFIG_FB_BRCM_ILI9486 is not set
# CONFIG_LCD_ILI9486_SUPPORT is not set
# CONFIG_LCD_R61531_SUPPORT is not set
# CONFIG_LCD_ILI9341_SUPPORT is not set
# CONFIG_LCD_ILI9341_I_SUPPORT is not set
# CONFIG_LCD_ILI9341_C_SUPPORT is not set
CONFIG_LCD_ILI9341_CRSC_SUPPORT=y
# CONFIG_LCD_ILI9486_SMI_SUPPORT is not set
CONFIG_SOUND=y
...
CONFIG_BCM_ALSA_SOUND=y
# CONFIG_BCM_AUDIO_SELFTEST is not set
# CONFIG_ENABLE_VOIF is not set
# CONFIG_VOIF_DUPLUX_UL_PCM is not set
# CONFIG_IHF_EXT_AMPLIFIER is not set
# CONFIG_ALLINONE_RCVSPK is not set
# CONFIG_STEREO_SPEAKER is not set
# CONFIG_EXTERNAL_AMP_GPIO is not set
CONFIG_ENABLE_SSMULTICAST=y
CONFIG_AUDIO_FEATURE_SET_DISABLE_ECNS=y
CONFIG_SND_USB=y
...
# CONFIG_USB_DUAL_DISK_SUPPORT is not set
CONFIG_USB_GADGET=y
...
# CONFIG_USB_DWC_OTG_HOST_MODE is not set
CONFIG_USB_DWC_OTG=y
CONFIG_USB_DELAYED_SUSPEND_POWER_SAVING=y
# CONFIG_USB_GADGET_DUMMY_HCD is not set
CONFIG_USB_GADGET_DUALSPEED=y
# CONFIG_USB_GADGET_SNPS_DWC_OTG is not set
# CONFIG_USB_LPM is not set
# CONFIG_USB_DWC_OTG_LPM is not set
# CONFIG_USB_DWC_OTG_DEVICE_ONLY is not set
...
# CONFIG_USB_G_ANDROID_SAMSUNG_COMPOSITE is not set
CONFIG_USB_G_ANDROID_ACM=y
CONFIG_USB_G_ANDROID_ADB=y
CONFIG_USB_G_ANDROID_MASS_STORAGE=y
# CONFIG_USB_G_ANDROID_MTP is not set
CONFIG_USB_G_ANDROID_RNDIS=y
# CONFIG_USB_G_ANDROID_RNDIS_WCEIS is not set
# CONFIG_USB_ETH_SKB_ALLOC_OPTIMIZATION is not set
CONFIG_USB_G_ANDROID_OBEX=y
# CONFIG_USB_G_ANDROID_2_6_SYSFS is not set
...
CONFIG_BCMPMU_OTG_XCEIV=y
# CONFIG_FSA9480_OTG_XCEIV is not set
# CONFIG_USB_SWITCH_TSU8111 is not set
# CONFIG_USB_BCM_OTG is not set
# CONFIG_SEC_MAKE_LCD_TEST is not set
CONFIG_MMC=y
# CONFIG_MMC_DEBUG is not set
CONFIG_MMC_UNSAFE_RESUME=y
CONFIG_MMC_45_FEATURE_SUPPORT=y
CONFIG_MMC_DISCARD_SUPPORT=y
CONFIG_MMC_DISCARD_SAMSUNG_eMMC_SUPPORT=y
...
#
CONFIG_MMC_SDHCI=y
CONFIG_MMC_SDHCI_PLTFM_KONA=y
CONFIG_MMC_KONA_SDIO_WIFI=y
...
CONFIG_BCM_SDIOWL=y
CONFIG_MMCPOLL=y
# CONFIG_MMCPOLL_TEST is not set
...
# on-CPU RTC drivers
#
# CONFIG_RTC_DRV_ISLAND is not set
CONFIG_RTC_DRV_BCMPMU=y
...
# CONFIG_SDHCI_THROUGHPUT is not set
...
CONFIG_BCMLOG_DEFAULT_LOGBUF_2M=y
CONFIG_SEC_DEBUG=y
...
CONFIG_CRYPTO_HW=y
# CONFIG_CRYPTO_DEV_BRCM_SPUM_HASH is not set
# CONFIG_CRYPTO_DEV_BRCM_SPUM_AES is not set
